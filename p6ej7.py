#juan gines ramis vivancos p6ej7 Escribe un programa que pida un número (límite) y luego te pida números hasta que la suma de los números introducidos supere el límite inicial.
numeros=[]
suma=0
